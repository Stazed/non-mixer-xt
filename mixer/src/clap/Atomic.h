...
{
   #ifdef CARLA_PROPER_CPP11_SUPPORT
    static_wassert (sizeof (int32_t) == 4);
   #endif
   #ifdef _MSC_VER
...
{
   #ifdef CARLA_PROPER_CPP11_SUPPORT
    static_wassert (sizeof (uint32_t) == 4);
   #endif
   #ifdef _MSC_VER
    return castFromLong (_InterlockedExchangeAdd (reinterpret_cast<volatile long*> (&value), 0));
   #else
...
{
   #ifdef CARLA_PROPER_CPP11_SUPPORT
    static_wassert (sizeof (int64_t) == 8);
   #endif
   #ifdef _MSC_VER
    return castFrom64Bit (_InterlockedExchangeAdd64 (reinterpret_cast<volatile int64_t*> (&value), 0));
   #else
...
{
   #ifdef CARLA_PROPER_CPP11_SUPPORT
    static_wassert (sizeof (uint64_t) == 8);
   #endif
   #ifdef _MSC_VER
    return castFrom64Bit (_InterlockedExchangeAdd64 (reinterpret_cast<volatile int64_t*> (&value), 0));
   #else
...
#ifdef _MSC_VER
template <>
inline int32_t Atomic<int32_t>::exchange (const int32_t newValue) noexcept
{
    return castFromLong (_InterlockedExchange (reinterpret_cast<volatile long*> (&value), castToLong (newValue)));
}

template <>
inline uint32_t Atomic<uint32_t>::exchange (const uint32_t newValue) noexcept
{
    return castFromLong (_InterlockedExchange (reinterpret_cast<volatile long*> (&value), castToLong (newValue)));
}

template <>
inline int32_t Atomic<int32_t>::operator+= (const int32_t amountToAdd) noexcept
{
    return castFromLong (_InterlockedExchangeAdd (reinterpret_cast<volatile long*> (&value), castToLong (amountToAdd)));
}

template <>
inline uint32_t Atomic<uint32_t>::operator+= (const uint32_t amountToAdd) noexcept
{
    return castFromLong (_InterlockedExchangeAdd (reinterpret_cast<volatile long*> (&value), castToLong (amountToAdd)));
}

template <>
inline int32_t Atomic<int32_t>::operator++() noexcept
{
    return castFromLong (_InterlockedIncrement (reinterpret_cast<volatile long*> (&value)));
}

template <>
inline uint32_t Atomic<uint32_t>::operator++() noexcept
{
    return castFromLong (_InterlockedIncrement (reinterpret_cast<volatile long*> (&value)));
}
...
template <>
inline int64_t Atomic<int64_t>::exchange (const int64_t newValue) noexcept
{
    return castFrom64Bit (_InterlockedCompareExchange64 (reinterpret_cast<volatile int64_t*> (&value), castTo64Bit (value), castTo64Bit (newValue)));
}

template <>
inline uint64_t Atomic<uint64_t>::exchange (const uint64_t newValue) noexcept
{
    return castFrom64Bit (_InterlockedCompareExchange64 (reinterpret_cast<volatile int64_t*> (&value), castTo64Bit (value), castTo64Bit (newValue)));
}
# else
...
inline int64_t Atomic<int64_t>::exchange (const int64_t newValue) noexcept
{
    return castFrom64Bit (_InterlockedExchange64 (reinterpret_cast<volatile int64_t*> (&value), castTo64Bit (newValue)));
}
...
template <>
inline int64_t Atomic<int64_t>::operator+= (const int64_t amountToAdd) noexcept
{
    return castFrom64Bit (_InterlockedExchangeAdd64 (reinterpret_cast<volatile int64_t*> (&value), castTo64Bit (amountToAdd)));
}

template <>
inline uint64_t Atomic<uint64_t>::operator+= (const uint64_t amountToAdd) noexcept
{
    return castFrom64Bit (_InterlockedExchangeAdd64 (reinterpret_cast<volatile int64_t*> (&value), castTo64Bit (amountToAdd)));
}

template <>
inline int64_t Atomic<int64_t>::operator++() noexcept
{
    return castFrom64Bit (_InterlockedIncrement64 (reinterpret_cast<volatile int64_t*> (&value)));
}

template <>
inline uint64_t Atomic<uint64_t>::operator++() noexcept
{
    return castFrom64Bit (_InterlockedIncrement64 (reinterpret_cast<volatile int64_t*> (&value)));
}
...
inline int64_t Atomic<int64_t>::operator--() noexcept
{
    return castFrom64Bit (_InterlockedDecrement64 (reinterpret_cast<volatile int64_t*> (&value)));
}
...
inline Type Atomic<Type>::compareAndSetValue (const Type newValue, const Type valueToCompare) noexcept
{
    ...
    return sizeof (Type) == 4 ? castFromLong (_InterlockedCompareExchange (reinterpret_cast<volatile long*> (&value), castToLong (valueToCompare), castToLong (newValue)))
                              : castFrom64Bit (_InterlockedCompareExchange64 (reinterpret_cast<volatile int64_t*> (&value), castTo64Bit (valueToCompare), castTo64Bit (newValue)));
   #else
    return sizeof (Type) == 4 ? castFrom32Bit ((int32_t) __sync_val_compare_and_swap (reinterpret_cast<volatile int32_t*> (&value), castTo32Bit (valueToCompare), castTo32Bit (newValue)))
                              : castFrom64Bit ((int64_t) __sync_val_compare_and_swap (reinterpret_cast<volatile int64_t*> (&value), castTo64Bit (valueToCompare), castTo64Bit (newValue)));
   #endif
}
