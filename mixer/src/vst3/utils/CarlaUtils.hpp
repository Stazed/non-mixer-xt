...
{
   WARNING("Carla assertion failure: \"%s\" in file %s, line %i", assertion, file, line);
}
...
{
   WARNING("Carla assertion failure: \"%s\" in file %s, line %i, value %i", assertion, file, line, value);
}
...
{
   WARNING("Carla assertion failure: \"%s\" in file %s, line %i, value %u", assertion, file, line, value);
}
...
{
   WARNING("Carla assertion failure: \"%s\" in file %s, line %i, v1 %i, v2 %i", assertion, file, line, v1, v2);
}
...
{
   WARNING("Carla assertion failure: \"%s\" in file %s, line %i, v1 %u, v2 %u", assertion, file, line, v1, v2);
}
...
{
   WARNING("Carla assertion failure: %s, condition \"%s\" in file %s, line %i", message, assertion, file, line);
}
