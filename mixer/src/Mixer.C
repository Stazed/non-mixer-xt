...
static int
osc_add_strip( const char *path, const char *, lo_arg **, int, lo_message msg, void *user_data )
{
    OSC_DMSG ( );
...
void
Mixer::cb_menu( Fl_Widget* o, void* v )
{
    ( (Mixer*) ( v ) )->cb_menu ( o );
}

bool
Mixer::is_valid_open_new( )
{
...
void
Mixer::update_frequency( float v )
{
...
void
Mixer::resize( int X, int Y, int W, int H )
{
