...
// Bugs: ?
/**
 * This is from version 1.3 because the 1.4 version somehow loses the mouse button events when 
 * the Fl_Scroll is needed...???
 */
...
*/
NMXT_Pack::NMXT_Pack(int X, int Y, int W, int H,const char *l)
: Fl_Group(X, Y, W, H, l) {
  resizable(0);
  spacing_ = 0;
